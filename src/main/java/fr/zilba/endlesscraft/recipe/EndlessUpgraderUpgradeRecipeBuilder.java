...
public class EndlessUpgraderUpgradeRecipeBuilder implements RecipeBuilder {
  ...
  public EndlessUpgraderUpgradeRecipeBuilder(RecipeSerializer<?> pType, Item pUpgrade, Ingredient pAddition, int pLevel, RecipeCategory pCategory) {
  ...
  public static EndlessUpgraderUpgradeRecipeBuilder upgrade(Item pUpgrade, Ingredient pAddition, int pLevel, RecipeCategory pCategory) {
    return new EndlessUpgraderUpgradeRecipeBuilder(ModRecipes.ENDLESS_UPGRADER_UPGRADE_SERIALIZER.get(), pUpgrade, pAddition, pLevel, pCategory);
  }
  ...
  public void save(Consumer<FinishedRecipe> pRecipeConsumer, ResourceLocation pLocation) {
    ...
    pRecipeConsumer.accept(new EndlessUpgraderUpgradeRecipeBuilder.Result(pLocation, this.type, this.upgrade, this.addition, this.level, this.advancement, pLocation.withPrefix("recipes/" + this.category.getFolderName() + "/")));
  }
